...
Later scope includes image-backed avatars/emotes/emoji in manually validated Kitty/Ghostty-compatible terminals, startup token validation, interactive login, setup wizard, secure credential storage, activity charts, and additional transport/image protocols.
