...
- A CLI/config foundation exists with a deterministic non-network Bubble Tea mock shell and a one-channel live Twitch IRC read path. Composer send wiring is still planned.
